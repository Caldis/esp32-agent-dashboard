 ...
 * mapping is needed by the dashboard scene, the sessions dual-pane, and
 * the prompt scene's badge. Centralising the table here means a new
 * tool icon ships in exactly one place.
 *
